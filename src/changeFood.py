...
#                     sleep(3.0)
#
#             intX,intY = FindPic(dm,25,478,51,503,u"C:/anjianScript/通用经验/换狗粮N.bmp","030303",0.8,0)
#             if intX>0:
